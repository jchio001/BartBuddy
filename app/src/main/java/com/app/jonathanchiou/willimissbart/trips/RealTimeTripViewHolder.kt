...
class RealTimeTripViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    val trainColorIndicator: View = itemView.findViewById(R.id.train_color_indicator)
    val departureTimeTextView: TextView = itemView.findViewById(R.id.destination_textview)
    val timeUntilArrivalTextView: TextView = itemView.findViewById(R.id.time_until_arrival_textview)
